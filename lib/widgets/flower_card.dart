...
class FlowerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                   top: 8,
                   left: 8, 
                   child: _RatingChip(rating: flower.rating) //untuk memanggil favorite chip
                   ), 
                  ...
                  Positioned(
                    ...
                    child: ValueListenableBuilder<Set<String>>(
                      valueListenable: FavoritesController.instance, //favoritesController.instance
                      builder: (context, favorites, _) {
                        final isFav = favorites.contains(flower.id);
                        return InkWell( //InkWell = Area yang sensitive dengan touch gesture
                          borderRadius: BorderRadius.circular(20),
    ...
    ); //AREA YANG SENSITIVE UNTUK DI TEKAN
  }
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(Icons.start_rounded, size: 13, color:Colors.amber),
          Text(
            rating.toString(),
            style: TextStyle(
              color: Colors.white,
